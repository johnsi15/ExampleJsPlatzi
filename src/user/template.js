...
export default function userPageTemplate(user){
          ...
          return yo`<div class="col s12 m6 l4">
            ...
            <div id="modal${picture.id}" class="modal modal-fixed-footer">
              ...
              <div class="modal-footer">                                    
                <div class="btn btn-flat likes"><i class="fa fa-heart"></i> ${translate.message('likes', { likes: picture.likes || 0})}</div>
              </div>
            </div>
          </div>`;
        })}
  ...
  return layout(el);//todo esto se devuelve al index.js y se agrega con el appendChild
}
// Esto es lo mismo que lo de export default
